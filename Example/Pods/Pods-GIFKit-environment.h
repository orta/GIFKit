...
// GIFKit
#define COCOAPODS_POD_AVAILABLE_GIFKit
#define COCOAPODS_VERSION_MAJOR_GIFKit 0
#define COCOAPODS_VERSION_MINOR_GIFKit 1
#define COCOAPODS_VERSION_PATCH_GIFKit 0
